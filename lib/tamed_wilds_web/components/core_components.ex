defmodule TamedWildsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TamedWildsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TamedWildsWeb.Gettext, "errors", msg, opts)
    end
  end
